...
export default () => <div class='flex h-full p-3'>
  ...
  <a class="toolbar-button" href="#journals" title="open journals">
  ...
  <a class="toolbar-button" href="#pages" title="open pages">
  ...
  <a class="toolbar-button" $onclick="@search-results" title="open search">
    <i class="">
