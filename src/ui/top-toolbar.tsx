...
export default () => <div class='flex h-full p-3'>
  <a class="my-auto mx-1 cursor-pointer" $onclick="@toggle-left-drawer">
    <i class="">
  ...
  <a class="my-auto mx-1 cursor-pointer">
    <i class="">
