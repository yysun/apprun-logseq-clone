...
export declare const create_block: (content: any) => Block;
export declare const delete_block: (block: any) => void;
export declare const update_block: (block: any, content: any) => void;
...
export declare const insert_block: (block: Block, target: BlockId) => void;
export declare const append_block: (block: Block, target: BlockId) => void;
